    ...
    <div class="container mx-auto px-4">
        ...
        <div class="grid md:grid-cols-4 gap-8">
            ...
            <div>
                ...
                <ul class="space-y-2">
                    <li><a href="opportunities.php?category=1" class="text-gray-400 hover:text-white transition duration-300">Category 1</a></li>
                    <li><a href="opportunities.php?category=2" class="text-gray-400 hover:text-white transition duration-300">Category 2</a></li>
                    <li><a href="opportunities.php?category=3" class="text-gray-400 hover:text-white transition duration-300">Category 3</a></li>
                    <li><a href="opportunities.php?category=4" class="text-gray-400 hover:text-white transition duration-300">Category 4</a></li>
                    <li><a href="opportunities.php?category=5" class="text-gray-400 hover:text-white transition duration-300">Category 5</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-2 text-gray-400">
                    ...
                    <li class="flex items-start">
                        ...
                        <a href="mailto:info@volunteerconnect.org" class="hover:text-white transition duration-300">info@volunteerconnect.org</a>
                    </li>
                    <li class="flex items-start">
